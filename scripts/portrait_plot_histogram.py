...
dd = da.stack()
dd = dd.reset_index()
dd = dd.rename(columns={"level_0": "model", "level_1": "field", 0 :"peak"})
...
for i, model in enumerate(model_names):
    ...
    for j, field in enumerate(field_list):
        filename = img_path+'hist_'+region+'_'+str(i)+"_"+str(j)+'.png'
...
num_fields = len(dd['field'].unique())
...
hvplot.save(peak_plot11, '../charts/peak_plot31.html')
